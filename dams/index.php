...
<option value="">Select Doctor</option>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                        <button type="submit" class="form-control" name="submit" id="submit-button"><a href="https://calendly.com/snehagautam2525/30min">Book a Online Meeting with our Consultant</a></button>
                                        </div>
                                    </div>
                                </form>
